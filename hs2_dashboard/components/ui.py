...
from ..data.kpi import KPI_DATA


def badge(text: str, kind: str = "neg") -> html.Span:
    colour_map = {
...
def stat_card(label: str, value: str, sub: str, delta: str = None, kind: str = "neg") -> html.Div:
...
def card(children, style: dict = None) -> html.Div:
...
def card_title(text: str, right=None) -> html.Div:
...
def narrative_box(tag_text: str, body_text: str, id_body: str = "narr-body-default") -> html.Div:
    return html.Div([
...
def risk_item(severity: str, name: str, desc: str) -> html.Div:
