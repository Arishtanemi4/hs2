...
from components.ui_components import card, card_title, section_header, badge, risk_item
from charts.risk_charts import fig_risk_radar
        ...
        html.Div([
            ...
            html.Div([
                ...
                card([
                    ...
                    html.Table([
                        html.Thead(html.Tr([
                            html.Th(h, style={"padding": "6px 8px", "color": C["muted"], "fontWeight": "400",
