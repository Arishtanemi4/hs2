...
def render_narrative():
    return html.Div([
        ...
        html.Div(id="narrative-output",
                 children=narrative_box(NARRATIVES["neu"]["tag"], NARRATIVES["neu"]["body"])),
